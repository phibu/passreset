...
public class WebSettings
{
    ...
    /// <summary>
    /// When true, the <see cref="PassReset.Web.Helpers.DebugPasswordChangeProvider"/> and
    /// <see cref="PassReset.Web.Helpers.NoOpEmailService"/> are registered instead of the
